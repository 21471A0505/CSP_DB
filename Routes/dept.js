...
Router.post("/Insert", (req, res) => {
  ...
  console.log(Details);
  Result("volunteer", "Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.delete("/Delete:ID", (req, res) => {
  ...
  Result("volunteer", "Delete", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:ID", (req, res) => {
  ...
  console.log(Details);
  Result("volunteer", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
